...
public class WorldLR extends Region implements World {
    ...
    private static final CssMetaData<WorldLR, Color>       LOCATION_COLOR   = FACTORY.createColorCssMetaData("-location-color", s -> s.locationColor, Color.web("#ffeb4d"), false);
